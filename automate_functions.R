...
run_all <- function(rare_prokaryot,rare_eukaryot,rare_fungi,summary_list) {
  ...
  top_taxa_heatmap(rare_prokaryot,get_top10_taxa(rare_prokaryot),'prokaryot_heatmap')
  top_taxa_heatmap(rare_eukaryot,get_top10_taxa(rare_eukaryot),'eukaryot_heatmap')
  top_taxa_heatmap(rare_fungi,get_top10_taxa(rare_fungi),'fungi_heatmap')
